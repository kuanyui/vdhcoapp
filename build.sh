...
if [ $publish == 1 ]; then
  files=(
    ...
    "dist/linux/i686/${package_binary_name}-no-ffmpeg-${meta_version}-linux-i686.tar.bz2"
    "dist/linux/i686/${package_binary_name}-${meta_version}-linux-i686.deb"
    "dist/linux/i686/${package_binary_name}-no-ffmpeg-${meta_version}-linux-i686.deb"
    "dist/linux/x86_64/${package_binary_name}-${meta_version}-linux-x86_64.tar.bz2"
    "dist/linux/x86_64/${package_binary_name}-no-ffmpeg-${meta_version}-linux-x86_64.tar.bz2"
    "dist/linux/x86_64/${package_binary_name}-${meta_version}-linux-x86_64.deb"
    "dist/linux/x86_64/${package_binary_name}-no-ffmpeg-${meta_version}-linux-x86_64.deb"
    "dist/linux/aarch64/${package_binary_name}-${meta_version}-linux-aarch64.tar.bz2"
    "dist/linux/aarch64/${package_binary_name}-no-ffmpeg-${meta_version}-linux-aarch64.tar.bz2"
    "dist/linux/aarch64/${package_binary_name}-${meta_version}-linux-aarch64.deb"
    "dist/linux/aarch64/${package_binary_name}-no-ffmpeg-${meta_version}-linux-aarch64.deb"
